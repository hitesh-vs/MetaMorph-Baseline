...
#SBATCH --output=/home/sviswasam/dr/metamorph/logs/output_main4.log
#SBATCH --error=/home/sviswasam/dr/metamorph/logs/err_main4.err
...
export CFLAGS="-Wno-implicit-function-declaration -Wno-int-conversion -Wno-error=implicit-function-declaration -Wno-error=incompatible-function-pointer-types"
# --- END MUJOCO CONFIG ---
