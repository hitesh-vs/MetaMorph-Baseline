...
python tools/evaluate.py --policy_path "/home/sviswasam/dr/ModuMorph/output_top4_ph1_copy" --policy_name Modular-v0 --seed 1409 --test_folder "/home/sviswasam/dr/ModuMorph/modular/unitree_g1_actual_test"