...
#SBATCH --output=/home/sviswasam/dr/ModuMorph/logs/output.log
#SBATCH --error=/home/sviswasam/dr/ModuMorph/logs/err.err
...
python tools/train_ppo.py --cfg ./configs/ft.yaml OUT_DIR ./output ENV.WALKER_DIR ./modular/humanoid_train RNG_SEED 1409 PPO.KL_TARGET_COEF 5. MODEL.TRANSFORMER.POS_EMBEDDING None MODEL.TRANSFORMER.EMBEDDING_DROPOUT False MODEL.TRANSFORMER.FIX_ATTENTION True MODEL.TRANSFORMER.HYPERNET True MODEL.TRANSFORMER.CONTEXT_ENCODER linear