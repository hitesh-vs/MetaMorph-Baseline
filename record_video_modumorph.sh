...
#SBATCH --output=/home/sviswasam/dr/ModuMorph/logs/output_video.log
#SBATCH --error=/home/sviswasam/dr/ModuMorph/logs/err_video.err
...
python tools/render_video.py --agent humanoid_2d_9_full --policy_path output_copy/1409 --agent_path modular/humanoid_train --num_episodes 10