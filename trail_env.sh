...
#SBATCH --output=/home/sviswasam/dr/ModuMorph/logs/output_trail.log
#SBATCH --error=/home/sviswasam/dr/ModuMorph/logs/err_trail.err
...
python -u tools/train_sample.py 2>&1 | tee unitree_env.log