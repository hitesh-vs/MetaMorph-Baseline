#!/usr/bin/env bash
# Script for just testing the trained model by collecting rewards
...
#SBATCH -t 00:05:00
#SBATCH --mem 32G
#SBATCH --job-name="eval_ppo_render"

# Log Names
#SBATCH --output=/home/sviswasam/dr/metamorph/logs/eval_render_out3.log
#SBATCH --error=/home/sviswasam/dr/metamorph/logs/eval_render_err3.err
...
# 6. EXECUTION
echo "Starting Evaluation using local_libs..."
python -u tools/eval_ppo.py